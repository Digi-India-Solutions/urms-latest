...
const AllCompleteTask = () => {
    ...
    useEffect(() => {
        const fetchTasks = async () => {
            try {
                const response = await axios.get('https://api.zaikanuts.shop/api/get-all-task');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://api.zaikanuts.shop/api/delete-task/${id}`);
      ...
      useEffect(() => {
        const fetchRemarkData = async () => {
            try {
                const response = await axios.get('https://api.zaikanuts.shop/api/get-remark');
    ...
    //     try {
    //         await axios.delete(`https://api.zaikanuts.shop/api/delete-task/${taskId}`);
