...
const TeamLeaderSignup = () => {
    ...
    const getApiData = async () => {
        try {
            const res = await axios.get("https://api.zaikanuts.shop/api/get-backend-record");
            if (res.status === 200) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://api.zaikanuts.shop/api/team-leader/signup', data);
